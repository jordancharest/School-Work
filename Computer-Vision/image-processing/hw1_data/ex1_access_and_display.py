...
def display_img_opencv_resize_first(img_name, img):
    """
    In order to handle the extreme size, we resize the image to a
    viewable size using OpenCV functions for resizing
    """
...
if __name__ == "__main__":
    ...
    print('Upper left corner green value (through item method): ',
          img.item(0, 0, 0))
    print('Upper left corner green value (through indexing): ', img[0, 0, 0])
