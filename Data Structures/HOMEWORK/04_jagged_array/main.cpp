...
void SimpleTest() {
  ...
  // variable 'ja' when we leave the function and it goes out of scope
}
...
void StudentTests() {
  ...
  std::cout << "\n\n\nSTUDENT TESTS\n Testing Integer datatype\n\n";

  JaggedArray<int> ja(7);
  ...
  assert (ja.numElementsInBin(5) == 0);
  assert (ja.numElementsInBin(6) == 1);
  assert (ja.getElement(1,0) == 0);
  assert (ja.getElement(1,1) == 6);
  assert (ja.getElement(1,2) == 1);
  assert (ja.getElement(3,0) == 9);
  assert (ja.getElement(3,1) == 6);
  assert (ja.getElement(6,0) == -1);
  ...
  std::cout << "\n\nSTUDENT TESTS ROUND 2\nTesting string data type\n\n";

  // test the copy constructor
  JaggedArray<std::string> a(5);
  a.addElement(1,"t");
  a.addElement(4,"f");
  a.addElement(3,"e");
  a.addElement(1,"s");
