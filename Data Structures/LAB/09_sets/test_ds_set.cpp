...
int main() {
  ...
  // ITERATIVE find
  std::cout << "\n\nITERATIVE REPLICATION OF FIND\n";
  p = set1.iterative_find("foo");
  if (p == set1.end())
    std::cout << "\"foo\" is not in the set\n";
  else
    std::cout << "\"foo\" is in the set\n"
